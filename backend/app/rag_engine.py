...
ANSWER:""",
    ...
    def get_stats(self) -> Dict:
        try:
            ...
            # Count unique documents by analyzing metadata
            ...
            return {
                "total_documents": total_documents,  # ✅ Actual document count
                "total_chunks": total_chunks,  # ✅ Chunk count
        ...
        try:
            ...
            if language != "en":
                ...
                for source in response.sources:
                    translated_snippet = (
                        translator.translate_legal_response(source.snippet, language)
                        if source.snippet
                        else source.snippet
                    )
                ...
                return ChatResponse(
                    answer=translated_answer, sources=translated_sources
                )
            else:
                return response
